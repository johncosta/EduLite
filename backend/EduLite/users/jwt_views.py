    ...
    **Token Lifetimes:**
    ...
    request=inline_serializer(
        ...
        fields={
            "username": serializers.CharField(
                help_text="Your username from registration"
            ),
    ...
    examples=[
        OpenApiExample(
            ...
            value={"username": "johndoe123", "password": "SecurePass123!"},
            request_only=True,
            description="Use the same credentials from registration",
        ),
        OpenApiExample(
            "Alternative Login",
            value={"username": "janedoe456", "password": "MyPassword2024"},
            request_only=True,
    ...
    responses={
        ...
        401: OpenApiResponse(
            ...
            examples=[
                ...
                OpenApiExample(
                    "Account Inactive", value={"detail": "User account is disabled."}
                ),
            ],
        ),
        400: OpenApiResponse(
        ...
        200: OpenApiResponse(
            ...
            response=inline_serializer(
                ...
                fields={
                    ...
                    "refresh": serializers.CharField(
                        help_text="New JWT refresh token (if rotation enabled)",
                        required=False,
                    ),
                },
            ),
