...
class TestUserProfileModel(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # cls.user1.userprofile should exist due to the signal
        # cls.user2.userprofile should also exist
    ...
    def test_profile_auto_creation_on_user_create(self):
        ...
        self.assertTrue(hasattr(self.user1, 'userprofile'))
        self.assertIsInstance(self.user1.userprofile, UserProfile)
        self.assertEqual(self.user1.userprofile.user, self.user1)
        ...
        with self.assertRaises(IntegrityError): # Or a more specific error if UserProfile.user is primary_key
             ...
             self.user1.userprofile = UserProfile(user=self.user1)
    ...
    def test_profile_friends_relationship(self):
        ...
        profile2 = self.user2.userprofile # Assuming user2 also has a profile auto-created
