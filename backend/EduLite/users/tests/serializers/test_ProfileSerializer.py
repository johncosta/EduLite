...
class ProfileSerializerTest(TestCase):
    ...
    def setUp(self):
        ...
        self.privacy_settings = UserProfilePrivacySettings.objects.get(user_profile=self.profile)
    ...
    def test_serializer_contains_expected_fields_for_owner(self):
        ...
        expected_fields = [
            'url', 'user', 'user_url', 'bio', 'occupation',
            'country', 'preferred_language', 'secondary_language',
            'picture', 'website_url', 'friends'
        ]
    ...
    def test_serializer_contains_limited_fields_for_strangers(self):
        ...
        serializer = ProfileSerializer(
            instance=self.profile,
            context=self.get_serializer_context(stranger)
        )
        data = serializer.data
    ...
    def test_serializer_contains_fields_for_friends(self):
        ...
        serializer = ProfileSerializer(
            instance=self.profile,
            context=self.get_serializer_context(friend)
        )
        data = serializer.data
    ...
    def test_empty_optional_fields_for_owner(self):
        ...
        serializer = ProfileSerializer(
            ...
            context=self.get_serializer_context(minimal_user)
        )
        data = serializer.data
    ...
    def test_admin_can_see_all_fields(self):
        ...
        serializer = ProfileSerializer(
            instance=self.profile,
            context=self.get_serializer_context(admin_user)
        )
        data = serializer.data
    ...
    def test_superuser_can_see_all_fields(self):
        ...
        serializer = ProfileSerializer(
            instance=self.profile,
            context=self.get_serializer_context(superuser)
        )
        data = serializer.data
