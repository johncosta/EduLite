...
def create_students_bulk():
    ...
    fatima.profile.bio = "Medical student in Khartoum. Power cuts daily but determination is constant."
    ...
    miguel.profile.bio = "Rio favela. Sharing one phone with siblings. Dreams bigger than circumstances."
    ...
    sophie.profile.bio = "Homeless shelter in Paris. Using library computers. Education is my way out."
    ...
    dmitri.profile.bio = "Displaced from Mariupol. Learning IT in Lviv shelter. Code is hope."
...
def create_teachers_bulk():
    ...
    ahmed.profile.bio = "Professor of Computer Science. Building bridges through online education."
    ...
    okonkwo.profile.bio = "Bringing quality education to rural Nigeria. Mobile learning advocate."
...
def setup_friend_relationships(students, teachers):
    ...
    teachers['ahmed'].profile.friends.add(students['ahmad'])  # Middle Eastern connection  
...
def create_student_marie_quebec():
    ...
    user.profile.bio = "Innu student from northern Quebec. Preserving our culture through education."
