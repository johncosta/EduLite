...
class IsFriendRequestReceiverOrSenderTest(TestCase):
    ...
    def test_has_object_permission_other_user_all_http_methods(self):
        ...
        for method in methods:
            with self.subTest(method=method):
                ...
                self.assertFalse(result, f"Other user should not be able to use {method}")
    ...
    def test_has_object_permission_user_without_profile(self):
        ...
        user_without_profile = User(username='no_profile', email='noprofile@example.com')
    ...
    def test_permission_message(self):
        ...
        expected_message = "You do not have permission to perform this action on this friend request."
