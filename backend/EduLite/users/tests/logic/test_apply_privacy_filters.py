...
class ApplyPrivacyFiltersTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.user_friends_only = User.objects.create_user(
            username='user_friends_only',
            first_name='Friends',
            last_name='Only'
        )
        cls.user_friends_only.profile.privacy_settings.search_visibility = 'friends_only'
        ...
        cls.user_friends_of_friends = User.objects.create_user(
            username='user_fof',
            first_name='Friends',
            last_name='Of Friends'
        )
        cls.user_friends_of_friends.profile.privacy_settings.search_visibility = 'friends_of_friends'
