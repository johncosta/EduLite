...
def get_random_occupation(
    occupation_choices_list, faker_instance=None
):  # Renamed for clarity
...
def get_random_country(
    country_choices_list, faker_instance=None
):  # Renamed for clarity
    return get_random_choice_from_list(country_choices_list)


def get_random_language(
    language_choices_list, faker_instance=None
):  # New generic language getter
