    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('FRIEND_REQUEST', 'Friend Request'), ('CHAT_INVITE', 'Chat Invitation'), ('NEW_MESSAGE', 'New Message'), ('SYSTEM_ANNOUNCEMENT', 'System Announcement')], db_index=True, max_length=50)),
